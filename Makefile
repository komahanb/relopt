...
FFLAGS  = -r16 -openmp -parallel -debug extended -ftrapuv
...
SRCS = dimrel.o mpi.o main.o

OBJS =  ${SRCS:.$(SUF)=.o}

all:  $(TARGET)

$(TARGET): $(OBJS) Eulersolve.a libmir.a tapenade.a pcestimate.a krigingestimate.a
	$(F90) $(FFLAGS) -o $(TARGET) $(OBJS) Eulersolve.a libmir.a tapenade.a pcestimate.a krigingestimate.a $(LFLAGS) -Wl,-rpath=.
	@echo " ----------- ${TARGET} created ----------- "
